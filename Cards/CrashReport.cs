...
namespace JoePitt.Cards
{
    ...
    {
        public string CrashReportPath { get; private set; }

        /// <summary>
        /// Generates a Crash Report to aid fault resolution.
        /// </summary>
        /// <param name="ex">The Unhandled Exception which triggered the report.</param>
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Design", "CA1031:DoNotCatchGeneralExceptionTypes")]
        public CrashReport(Exception ex)
        {
            CrashReportPath = Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments) + "\\CardsCrashReport-" + DateTime.Now.ToString("yyyyMMdd_HHmmss") + ".xml";
            ...
            else
            {
                ...
                gameStatus.Add(GetCardSetDetails());
                ...
                gameStatus.Add(GetClientsDetails());
            ...
            crashReport.Save(CrashReportPath);
        }
        ...
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Design", "CA1031:DoNotCatchGeneralExceptionTypes")]
        private static XElement GetCardSetDetails()
        {
        ...
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Design", "CA1031:DoNotCatchGeneralExceptionTypes")]
        private static XElement GetClientsDetails()
        {
        ...
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Design", "CA1031:DoNotCatchGeneralExceptionTypes")]
        private static XElement GetPlayersDetails()
        {
        ...
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Design", "CA1031:DoNotCatchGeneralExceptionTypes")]
        private static XElement GetAnswersDetails()
        {
        ...
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Design", "CA1031:DoNotCatchGeneralExceptionTypes")]
        private static XElement GetVotesDetails()
        {
        ...
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Design", "CA1031:DoNotCatchGeneralExceptionTypes")]
        private static XElement GetWinnersDetails()
        {
